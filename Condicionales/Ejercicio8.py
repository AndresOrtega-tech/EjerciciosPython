...
# traduciéndose en mejores beneficios. Los puntos que pueden conseguir los empleados pueden ser 0.0, 0.4, 0.6 o más, pero no valores intermedios entre las cifras 
...
if puntuacion == 0.0:
    ...
    print(f'Aceptable, tu pago es de {0.4*pago}')
elif puntuacion >= 0.6:
    print(f'Aceptable, tu pago es de {puntuacion*pago}')
else:
    print('Esa puntuacion no existe')